    ...
    <div>
      ...
      <div className='center'>
        <div className='profile'>
          ...
          <p style={{ fontSize: "20px" }}><strong  >會員信箱: </strong>{currentUser?.email}</p>
          <div style={{ height: "5px" }} ></div>
          <div style={{ display: "flex", textAlign: "center", fontSize: "20px" }} >
            <strong   >會員姓名: </strong>
            <StyledEdiText
              value={displayName}
              type="text"
          ...
          <div style={{ display: "flex", justifyContent: " space-between" }}>
            <Button variant="outlined" style={{ fontSize: "16px" }} onClick={handleClickOpen}>刪除帳號</Button >
            <br />
            <Button variant="outlined" style={{ fontSize: "16px" }} onClick={() => triggerChangeUserPassword()}>發送修改密碼信件</Button >
          </div>
          <Dialog
            open={open}
            onClose={handleClose}
          ...
          >
            ...
            <DialogActions>
              <Button style={{ fontSize: "20px" }} onClick={handleClose}>不刪除</Button>
              <Button style={{ fontSize: "20px" }} onClick={() => triggerDeleteUser()} autoFocus>
                確認刪除帳號
              </Button>
            </DialogActions>
          </Dialog>
          ...
          >
            <DialogTitle style={{ fontSize: "20px" }} id="alert-dialog-title-EmailConfirm">
              {"發送修改密碼信件成功，請至信箱確認"}
            </DialogTitle>
            <DialogActions>
              <Button style={{ fontSize: "20px" }} onClick={handleCloseEmailConfirm}>確認</Button>
            </DialogActions>
          </Dialog>
          ...
          <Dialog
            ...
            <DialogTitle style={{ fontSize: "20px" }} id="alert-dialog-title-Img">
              {"大頭貼上傳成功!!"}
            </DialogTitle>
            <DialogActions>
              <Button style={{ fontSize: "20px" }} onClick={handleCloseImg}>確認</Button>
            </DialogActions>
          </Dialog>
          ...
          <Dialog
            ...
            <DialogTitle style={{ fontSize: "20px" }} id="alert-dialog-title-Name">
              {"會員姓名修改成功!!"}
            </DialogTitle>
            <DialogActions>
              <Button style={{ fontSize: "20px" }} onClick={handleCloseName}>確認</Button>
            </DialogActions>
          </Dialog>
