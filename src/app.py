...
for pg in range(1,12):
    try:
        ...
        for x in Soup.find_all('input'):  # 網頁的整個資料 找到input標籤
            ...
            try:
                # 法院
                print("section_top_left.contents[1]",section_top_left.contents[1].contents[0].strip()) 
            ...
            try:
                # 人氣數量
                print("section_top_left.contents[1]",section_top_left.contents[1].contents[5].contents[1].string)  
            ...
            try:
                # thisId 110逸116965
                print("section_top_left.contents[5]", section_top_left.contents[5].get("value"))  
            ...
            try:
                # 網址 c
                print("section_top_left.contents[7]",section_top_left.contents[7].get("value"))  
